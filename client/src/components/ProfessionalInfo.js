...
//   updating the state variables, when props change
  useEffect(() => {
    setHighestEducation(props.ProfessionalInfo[0]);
    setJob(props.ProfessionalInfo[1]);
  }, [props]);

    // Post for updating professional info
        ...
        <fieldset id="disableField2" className="row" disabled>
          <div className="row my-1">
            <div className="col-lg-6">
              <label className=" mb-1 webTitles fontBlue ">
                Highest education
              </label>
              <div className="d-flex bg-white rounded dropdown">
                <select
                  className="btn btn-white dropdown-toggle text-start border-0"
                  onLoad={(e) => setHighestEducation(e.target.value)}
                  value={highestEducation}
                  onChange={(e) => setHighestEducation(e.target.value)}
                  style={{ width: "-webkit-fill-available" }}
                >
                  <option className="dropdown-item" value="primary">
                    Primary
                  </option>
                  <option className="dropdown-item" value="secondary">
                    Secondary
                  </option>
                  <option className="dropdown-item" value="higher secondary">
                    Higher Secondary
                  </option>
                  <option className="dropdown-item" value="graduation">
                    Graduation
                  </option>
                  <option className="dropdown-item" value="post graduation">
                    Post Graduation
                  </option>
                </select>
              </div>
            ...
            <div className="col-lg-6">
              ...
              <div className="d-flex bg-white rounded dropdown">
                <select
                  ...
                  style={{ width: "-webkit-fill-available" }}
                >
                  <option className="dropdown-item" value="schooling">
                    Schooling
                  </option>
                  <option className="dropdown-item" value="college">
                    College Student
                  </option>
                  <option className="dropdown-item" value="teaching">
                    Teaching
                  </option>
                  <option className="dropdown-item" value="job">
                    Job
                  </option>
                  <option className="dropdown-item" value="freelancing">
                    Freelancing
                  </option>
                </select>
              </div>
