...
export const ProfileBanner = () => {
  ...
  // for other components(will be passed as props)
  ...
  return (
    <div>
      <div
        className="backBanner d-flex bg-white px-5"
        style={{ height: "110px" }}
      >
        <div
        ...
        >
          <img
            ...
            src={image ? image : require("./logo.png")}
            alt=""
          />
          <button
            type="button"
            className="btn bg-dark editIcon"
        ...
        >
          <div className="d-flex flex-column justify-content-center ">
            <p
              className="text-dark mb-0 p-0 fontBlue"
              style={{ fontSize: "1.50rem", fontWeight: "300" }}
            >
              Hello,
            </p>
            <p
              className="text-dark fw-bold mb-0 p-0 fontBlue"
              style={{ fontSize: "24px" }}
            >
              {firstName}
            </p>
            <p
              className="text-dark pt-0 fontBlue"
          ...
          <Link id="followers" className="nav-link" to="/followers">
            <h5>5 Followers</h5>
          </Link>
        </div>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
                  ...
                  <div className="col-4">
                    <div className="d-flex h-100 align-items-center justify-content-center">
                      ...
                      <div className="input-group">
                        <label
                          className="btn bg-dark editIcon rounded-circle bg-white shadow"
                        ...
                        <input
                          className="btn bg-dark editIcon form-control"
                          type="file"
              ...
              <div className="modal-footer border-0">
                ...
                <button
                  type="button"
                  className="btn text-white myOrange"
                  onClick={updateInfo}
                >
                  Save changes
                </button>
...
// To handle image and convert it to base64, the passing to the method postImage
const handleImage = (e) => {
