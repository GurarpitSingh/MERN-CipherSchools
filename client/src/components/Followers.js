    ...
    <div className='container p-5'>
        ...
        <div className="d-flex flex-column">
            <div className="d-flex justify-content-between w-100">
                    ...
                    <Link to='/' className=" myOrange rounded btn " >Profile</Link>
            ...
            <div className="ms-2 row w-100">
                {followers.map((follower, i) => {
                    ...
                    return(
                        <Card className='border-0 shadow-sm mx-2 my-2' key={i} style={{ width: '18rem', 'max-height': '389px' }}>
                            <Card.Img variant="top" className='px-5 py-2 rounded-circle' style={{ height: '200px' }}  src={follower.Image} />
                            <Card.Body>
                                ...
                                <Button variant=" myOrange " style={{width: '-webkit-fill-available'}}>Follow</Button>
                                </div>
