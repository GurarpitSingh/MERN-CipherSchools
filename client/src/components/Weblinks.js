...
const Weblinks = (props) => {
  ...
  return (
    // Note: Didn't used the map function here, because the input fields are not in an array, as well as the icons are not in an array and were breaking the code
    <div>
          ...
          <div className="row my-1">
            <div className="col-lg-4">
              ...
              <div className="d-flex bg-white rounded">
                <box-icon
                  type="logo"
                  class="bg-secondary round ms-3 my-1 me-1 "
                  size="sm"
                  color="white"
                  name="linkedin"
                ></box-icon>
